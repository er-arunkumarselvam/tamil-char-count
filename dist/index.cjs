...
const $99c041d34ca81128$export$81441ef93d55980e = {
    "\u0B85": "vowels",
    "\u0B86": "vowels",
    "\u0B87": "vowels",
    "\u0B88": "vowels",
...
var $823e42faaa542640$var$CharType;
(function(CharType) {
...
const $823e42faaa542640$var$OM = "\u0BD0";
...
class $823e42faaa542640$export$3ae2e3e9a9c21123 {
    constructor(value){
        this.#getCharType = (char)=>{
            ...
            return (0, $99c041d34ca81128$export$81441ef93d55980e)[char] ?? "unrecognised";
        };
        ...
        this.isOm = ()=>this.value === $823e42faaa542640$var$OM;
        ...
        this.isMatra = ()=>$823e42faaa542640$var$MATRAS.includes(this.value);
        this.isJoiner = ()=>[
                "zwnj",
                "zwj"
            ].includes(this.type);
...
var $3aefcdddac337967$export$f435f793048e7a0f;
(function(TokenType) {
...
var $bf01d1d1fdea4641$export$43f5c03b889fb331;
(function(VarnaType) {
...
var $da2f48c805d435e9$var$State;
(function(State) {
